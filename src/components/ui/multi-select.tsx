...
interface MultiSelectOption {
  ...
  label: string;
  /** The text to display for the option in popover. */
  fullLabel?: string;
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const [buttonWidth, setButtonWidth] = React.useState<string | number>(
      'auto',
    );
    ...
    const filteredOptions = React.useMemo(() => {
      ...
      return options.filter(
        (option) =>
          ...
          option.fullLabel?.toLowerCase().includes(searchValue.toLowerCase()) ||
          option.value.toLowerCase().includes(searchValue.toLowerCase()),
      );
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              `
                flex !bg-background w-full items-center justify-between outline-none border border-input shadow-xs shadow-black/5 transition-shadow hover:bg-background !focus:bg-background !focus-visible:bg-background !active:bg-background
                text-foreground data-placeholder:text-muted-foreground 
                focus:border-ring focus:ring-[3px] focus:ring-ring/30 
                focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/30 
                active:border-ring active:ring-[3px] active:ring-ring/30 
                disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 
                aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10 dark:aria-invalid:border-destructive dark:aria-invalid:ring-destructive/20
                [[data-invalid=true]_&]:border-destructive/60 [[data-invalid=true]_&]:ring-destructive/10 dark:[[data-invalid=true]_&]:border-destructive dark:[[data-invalid=true]_&]:ring-destructive/20
              `,
              isPopoverOpen && 'border-ring ring-[3px] ring-ring/30', // Thêm ring khi popover mở
        ...
        <PopoverContent
          className={cn(
            ...
            screenSize === 'mobile' && 'max-w-[280px]',
            screenSize === 'tablet' && 'max-w-md',
            screenSize === 'desktop' && 'min-w-[300px]',
            popoverClassName,
          )}
          style={{
            width: buttonWidth, // Áp dụng chiều rộng của Button
        ...
        >
          <Command>
            ...
            >
              ...
              {(!hideClearButton || !hideCloseButton) && (
                <>
                  <CommandSeparator />
                  <CommandGroup>
                    <div className="flex items-center justify-between">
                      {selectedValues.length > 0 && !hideClearButton && (
                        <>
                          <CommandItem
